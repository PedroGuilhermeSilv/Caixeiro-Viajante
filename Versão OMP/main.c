...
arqX = fopen("C://Users//caminho//grafoX.txt", "rt");  // Cria um arquivo texto para leitura
arqY = fopen("C://Users//caminho//grafoY.txt", "rt");  // Cria um arquivo texto para leitura
